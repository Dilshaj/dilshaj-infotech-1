    ...
    return (
        <div className={`relative z-1000 ${className}`}>
            ...
            >
                <div
                    ref={navItemsRef}
                    className="relative items-center rounded-full hidden md:flex backdrop-blur-md border border-(--glass-border)"
                    style={{
                        height: 'var(--nav-h)',
                        background: 'var(--base)'
                    }}
                        ...
                        {items.map((item, i) => {
                            ...
                            const PillContent = (
                                <>
                                    ...
                                    {/* Removed active state dot per user request */}

                                </>
                            );

                            const basePillClasses =
                                'relative overflow-hidden inline-flex items-center justify-center h-full no-underline rounded-full box-border font-semibold text-[12px] lg:text-[14px] leading-[0] uppercase tracking-[0.2px] whitespace-nowrap cursor-pointer px-0';
                ...
                >
                    <span
                        className="hamburger-line w-4 h-0.5 rounded origin-center transition-all duration-100"
            ...
            <div
                ref={mobileMenuRef}
                className="md:hidden absolute top-[3.5em] left-4 right-4 rounded-[27px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] z-998 origin-top overflow-hidden"
                style={{
                    ...cssVars,
